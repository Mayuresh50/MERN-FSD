...
- Promise.all([p1, p2, p3])  //returns array of promises if all are succeded, and didn't return array if anyone fails
- Promise.race([p1, p2, p3]) //Jo pehla promise pending se reject ya phir resolve state pe pohuch jayega
- Promise.any([p1, p2, p3]) /Jo pehla promise resolve ho jayega
- Promise.allSettled([p1, p2, p3]) //Sab ko execute hone ka wait karega, takes max time of all promises
*/
...
//Response ki body bas ek hi baar use ho sakti hain 
